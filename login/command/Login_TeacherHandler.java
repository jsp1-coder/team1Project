...
public class Login_TeacherHandler implements CommandHandler {

	private static final String FORM_VIEW = "main/login/teacher_login";
	...
	throws Exception {
		...
		try {
			...
			response.sendRedirect(request.getContextPath() + "/main/teacher_main.do");
			return null;			
