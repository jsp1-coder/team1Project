...
public class Aftercard_class_DAO {
	// 싱글톤
	private static Aftercard_class_DAO dao = null;
	private Aftercard_class_DAO() {}
	public static Aftercard_class_DAO getInstance() {
		if( dao == null ) {
			dao = new Aftercard_class_DAO();
		}
		return dao;
	}
